...
VL_ATTR_COLD void Vdebug_simple_test_pkt_in___ctor_var_reset(Vdebug_simple_test_pkt_in* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdebug_simple_test_pkt_in___ctor_var_reset\n"); );
    ...
    vlSelf->pkt_in_rdy = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6084939215264989611ull);
}
