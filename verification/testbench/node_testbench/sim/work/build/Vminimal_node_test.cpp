...
void Vminimal_node_test___024root__trace_decl_types(VerilatedFst* tracep);

void Vminimal_node_test___024root__trace_init_top(Vminimal_node_test___024root* vlSelf, VerilatedFst* tracep);
...
VL_ATTR_COLD void Vminimal_node_test::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    ...
    if (VL_UNLIKELY(!stfp)) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vminimal_node_test::trace()' called on non-VerilatedFstC object;"
